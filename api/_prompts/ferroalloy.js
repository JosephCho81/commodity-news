...
10. 가격 표기 원칙:
    - price_cny 필드: 숫자만 (예: 5950). USD 환산은 서버에서 자동 계산되므로 텍스트 필드에 USD 직접 기재 금지.
    - supply_cause, demand_cause, context, market_summary, steel_signal_reason 등 모든 텍스트 필드에서 FeSi·FeMn·SiMn 가격 언급 시 CNY x,xxx/MT 형식만 사용. USD 직접 표기 절대 금지.
    - 예) "FeSi 현물가 CNY 5,950/MT 수준으로 전월比 상승세" (USD 표기 없이 CNY만)
...

{
  ...
  "market_summary": {
    "fesi": "FeSi 현황: 가격 수준·방향·주요 공급수요 원인 요약. 1~2문장. 종결어미 금지. 가격은 CNY x,xxx/MT 형식만 (예: CNY 5,950/MT).",
    "femn": "FeMn 현황: 가격 수준·방향·망간광석 원가·주요 요인 요약. 1~2문장. 종결어미 금지. 가격은 CNY x,xxx/MT 형식만.",
    "simn": "SiMn 현황: 가격 수준·방향·주요 요인 요약. 1~2문장. 종결어미 금지. 가격은 CNY x,xxx/MT 형식만.",
